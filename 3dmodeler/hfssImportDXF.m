...
%               * true  --> import 2D
%               * false --> import 3D
%   units:    specify the units of the imported model (can be
%             numeric, or a string supported by HFSS).
% 
% Note :
% ------
% Supported units strings: 
%   'cm', 'dm', 'fm', 'ft', 'in', 'km', 'lightyear', 'meter', 'mil', 'mile',
%   'mileNaut', 'mileTerr', 'mm','nm', 'pm', 'uin', 'um', 'yd'
%
% Full function call is function hfssImportDXF(fid, fileName, modelName, units, twoDim)
% 
%
% Example :
% ---------
...
% CHANGELOG
%
% 08-Jun-2017: *Initial release (K1TCH).
% 10-Oct-2024: *Merged into repository.
%              *Description reformatted.
% ----------------------------------------------------------------------------

% ----------------------------------------------------------------------------
% Written by K1TCH, Daniel R. Prado
