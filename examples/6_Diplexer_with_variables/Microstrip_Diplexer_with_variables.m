...
% 5) Variables in HFSS can be found in HFSS>Design Properties
%
...
% Variable Defining
hfssSetVariable(fid, 'substrate_L', substrate_L, units);
hfssSetVariable(fid, 'substrate_W', substrate_W, units);
hfssSetVariable(fid, 'substrate_H', substrate_H, units);
hfssSetVariable(fid, 'substrate_Er', substrate_Er,'');
hfssSetVariable(fid, 'substrate_tand', substrate_tand, units);

hfssSetVariable(fid, 'Cu_thickness', Cu_thickness, units);
hfssSetVariable(fid, 'W1a', W1a, units);
hfssSetVariable(fid, 'W1b', W1b, units);
hfssSetVariable(fid, 'W1c', W1c, units);
hfssSetVariable(fid, 'L1a', L1a, units);
hfssSetVariable(fid, 'L1b', L1b, units);
hfssSetVariable(fid, 'L1c', L1c, units);
hfssSetVariable(fid, 'W2L', W2L, units);
hfssSetVariable(fid, 'W2H', W2H, units);
hfssSetVariable(fid, 'Wf', Wf, units);
hfssSetVariable(fid, 'gf', gf, units);
hfssSetVariable(fid, 'Lf', Lf, units);
hfssSetVariable(fid, 'Lc', Lc, units);
hfssSetVariable(fid, 'grL', grL, units);
hfssSetVariable(fid, 'grH', grH, units);
hfssSetVariable(fid, 'LtL', LtL, units);
hfssSetVariable(fid, 'LtH', LtH, units);

% Assumed, Not sure about the lengths
hfssSetVariable(fid, 'L2H', L2H, units);
hfssSetVariable(fid, 'L2L', L2L, units);
hfssSetVariable(fid, 'L2V', L2V, units);

hfssSetVariable(fid, 'center_offset', center_offset, units);
hfssSetVariable(fid, 'W_ANT', W_ANT, units);
hfssSetVariable(fid, 'L_ANT', L_ANT, units);
hfssSetVariable(fid, 'length_of_port', length_of_port, units);
% Modelling
...
Trace_names={'T_arm_c', 'T_arm_c_1', 'T_arm_b', 'T_arm_b_1','R11', 'R2_H_1', 'R2_H_2', 'R2_H_3'...
...
% Boundaries
hfssAssignPE(fid, 'TracePE',0, Trace_names);
hfssAssignPE(fid, 'CuBottomPE', 0, {'cu_cladding_bottom'});
WCS_X='-substrate_L/2';
WCS_Y='-substrate_W/2';
hfssBox(fid, 'AirBox', {WCS_X, WCS_Y, 0}, {'substrate_L', 'substrate_W', 50}, units);
